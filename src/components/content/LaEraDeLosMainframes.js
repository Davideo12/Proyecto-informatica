...
function LaEraDeLosMainframes() {
    return ( 
        <section className='content-section'>
            ...
            <div>
                <p>La era de los mainframes se refiere a un período en la historia de la computación que abarcó desde la década de 1950 hasta la década de 1980. Durante este tiempo, los mainframes eran el tipo de computadora más grande y poderoso disponible, y se utilizaban principalmente por grandes empresas y organizaciones gubernamentales para procesar grandes cantidades de información.</p>
                <p>Los mainframes se caracterizaban por su capacidad de procesamiento de datos a alta velocidad y su capacidad para soportar múltiples usuarios simultáneamente. Además, estas computadoras eran altamente confiables y seguras, lo que las hacía ideales para su uso en aplicaciones críticas, como la gestión de transacciones financieras y de grandes bases de datos gubernamentales.</p>
                <p>Una de las principales ventajas de los mainframes era su capacidad de procesar grandes cantidades de datos de manera eficiente. En lugar de procesar datos en pequeñas partes, los mainframes podían procesar grandes volúmenes de datos de manera simultánea, lo que les permitía procesar transacciones y operaciones complejas en un tiempo récord.</p>
                ...
                <p>Con el tiempo, los mainframes evolucionaron y se hicieron más pequeños, potentes y fáciles de usar. Además, el desarrollo de la tecnología de red permitió conectar varios mainframes entre sí, lo que permitió el procesamiento distribuido de datos y la creación de sistemas informáticos complejos.</p>
                ...
                <p> A pesar de esto, los mainframes siguen siendo una parte importante de la historia de la informática, y su impacto en el desarrollo de la tecnología sigue siendo evidente en la actualidad.</p>
            </div>
        </section>
     );
}

export default LaEraDeLosMainframes;